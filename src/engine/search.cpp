...
static std::optional<Move> best_move;
static int root_depth;

static int minimax(Board& board, const int depth, int alpha, int beta) {
...
static Move search(Board& board, const int depth, int& eval) {
    root_depth = depth;
